<header class="site-header">
	    <div class="container-fluid">
	        <a href="#" class="site-logo">
	            <img class="hidden-md-down" src="{{ url('public/admin/img/logo-2.png')}}" alt="">
	            <img class="hidden-lg-up" src="{{ url('public/admin/img/logo-2-mob.png')}}" alt="">
	        </a>
	                ...
	                <div class="site-header-shown">
	                        ...
	                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-notif" aria-labelledby="dd-notification">
	                            ...
	                            <div class="dropdown-menu-notif-list">
	                                <div class="dropdown-menu-notif-item">
	                                    <div class="photo">
	                                        <img src="{{url('public/admin/img/photo-64-1.jpg')}}" alt="">
	                                    </div>
	                                    <div class="dot"></div>
	                                ...
	                                <div class="dropdown-menu-notif-item">
	                                    <div class="photo">
	                                        <img src="{{url('public/admin/img/photo-64-2.jpg')}}" alt="">
	                                    </div>
	                                    <div class="dot"></div>
	                                ...
	                                <div class="dropdown-menu-notif-item">
	                                    <div class="photo">
	                                        <img src="{{url('public/admin/img/photo-64-3.jpg')}}" alt="">
	                                    </div>
	                                    <div class="dot"></div>
	                                ...
	                                <div class="dropdown-menu-notif-item">
	                                    <div class="photo">
	                                        <img src="{{url('public/admin/img/photo-64-4.jpg')}}" alt="">
	                                    </div>
	                                ...
	                                <div class="tab-pane active" id="tab-incoming" role="tabpanel">
	                                    <div class="dropdown-menu-messages-list">
	                                        <a href="#" class="mess-item">
	                                            <span class="avatar-preview avatar-preview-32"><img src="{{url('public/admin/img/photo-64-2.jpg')}}" alt=""></span>
	                                            <span class="mess-item-name">Tim Collins</span>
	                                            <span class="mess-item-txt">Morgan was bothering about something!</span>
	                                        </a>
	                                        <a href="#" class="mess-item">
	                                            <span class="avatar-preview avatar-preview-32"><img src="{{url('public/admin/img/avatar-2-64.png')}}" alt=""></span>
	                    ...
	                    <div class="dropdown user-menu">
	                        <button class="dropdown-toggle" id="dd-user-menu" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
	                            <img src="{{url('public/admin/img/avatar-2-64.png')}}" alt="">
	                        </button>
	                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dd-user-menu">
	                            <a class="dropdown-item" href="#"><span class="font-icon glyphicon glyphicon-user"></span>name</a>
